...
const ChatBoxTopHeader = ({
  ...
  const isLoggedUserInGroup = activeChat?.users?.find(
    (auser) => auser._id === user?._id
  )
    ? true
    : false;
          ...
          >
              ...
              <Avatar
                ...
                src={
                  activeChat?.isGroupChat
                    ...
                    : getSender(user, activeChat?.users).avatar
                }
            ...
            {!activeChat ? (
              ...
              <div className="flex flex-col flex-1">
                <p className=" font-nunito font-semibold text-center tracking-wide capitalize">
                  {activeChat?.isGroupChat
                    ? activeChat?.groupName
                    : getSender(user, activeChat?.users).name}
                </p>
                <p className=" font-nunito text-sm text-center text-gray-500 flex items-center justify-center ">
                  {activeChat?.isGroupChat ? (
                    <span>
                    ...
                    getSender(user, activeChat?.users).email
                  )}
                </p>
              </div>
            )}
            <IconButton
              ...
              disabled={activeChat?.isGroupChat && !isLoggedUserInGroup}
            >
              ...
              >
                ...
                <DialogContent>
                  <DialogContentText id="dialog-description">
                    ...
                    will delete all the messages as well.
                  </DialogContentText>
                </DialogContent>
                <DialogActions sx={{ marginRight: "12px" }}>
                  ...
                  <Button autoFocus onClick={deleteChatFromList} color="error">
                    Delete
                  </Button>
                </DialogActions>
              </Dialog>
            )}
            {showChatInfo && activeChat?.isGroupChat && (
              <GroupChatInfoModal
                toggleShow={setShowChatInfo}
                show={showChatInfo}
          ...
          >
            ...
            {!activeChat ? (
              ...
              <div className="flex flex-col flex-1 ml-5 ">
                <p className=" font-nunito font-semibold text-[15px] tracking-wide capitalize">
                  {activeChat?.isGroupChat
                    ? activeChat?.groupName
                    : getSender(user, activeChat?.users).name}
                </p>
                <p className=" font-nunito text-xs  text-gray-500 flex items-center  ">
                  {activeChat?.isGroupChat ? (
                    <span>
                      Group - {activeChat?.users.length}{" "}
                      {activeChat?.users.length > 1
            ...
            <IconButton
              color="error"
              onClick={deleteAndGoBackToChats}
              disabled={activeChat?.isGroupChat && isLoggedUserInGroup}
            >
            ...
            >
              <SingleChatInfoModal
                chat={activeChat}
                showSingleChatDrawer={showSingleChatDrawer}
                setShowSingleChatDrawer={setShowSingleChatDrawer}
              />
            </Drawer>
            <Drawer
              anchor="right"
