  ...
  return (
    <>
      <div className="!hidden w-[35vw] h-screen md:!flex flex-col items-center overflow-y-auto bg-slate-50 relative scrollbar-thin scrollbar-thumb-purple-300 scrollbar-track-purple-100 transition-all">
        <div
          className={`w-[93%] mx-auto flex justify-center items-center rounded-xl my-4 relative`}
        >
          {!user ? (
            ...
            <div className="relative">
              <IconButton
                ...
                onClick={() => navigate("/loginchangeavatar")}
              >
                <Badge color="error" overlap="circular">
                  <EditIcon fontSize="1rem" color="action" />
                </Badge>
              </IconButton>
              <div className="h-36 w-36 rounded-full mx-auto flex justify-center items-center my-2 z-20 relative transition-all ">
                <Avatar
                  src={user.avatar}
                  alt="avatar"
          ...
          <div className="absolute bg-white w-60 rounded-lg -bottom-14 pt-14 shadow-sm flex flex-col items-center justify-center">
            <p className="font-nunito capitalize font-semibold flex justify-center items-center text-lg">
              {user.name}{" "}
              <span className="!ml-1">
                <VerifiedIcon color="secondary" fontSize=".9rem" />
              </span>{" "}
            </p>
            <p className="font-nunito tracking-wide text-sm text-slate-600 mb-2 font-light">
              {user.email}
            </p>
          </div>
        </div>
        ...
        {user?.isAvatarSet && (
          <Button
            variant="outlined"
            color="error"
            className="!capitalize !font-nunito !tracking-wide !mt-16 !mb-5 !font-semibold !bg-white"
            onClick={removeAvatarUniversally}
            disabled={loading || !user?.isAvatarSet}
          >
            Remove profile picture
          </Button>
        )}
        {/* center options   */}
        <div
          className={`w-[80%] mx-auto mt-4 mb-[4.2rem] outline-none h-[40vh] ${
            !user?.isAvatarSet ? "mt-[4.5rem]" : ""
          }`}
        >
          <Accordion
            sx={{
              border: "1.5px solid #7B1FA0",
              boxShadow: "none",
              marginBottom: "5px",
            }}
          >
            <AccordionSummary
              ...
              id="pannel-header"
            >
              <p className="!font-nunito !text-gray-700 !font-semibold !my-0 capitalize">
                Update username
              </p>
            </AccordionSummary>
            <AccordionDetails>
          ...
          >
            ...
            <AccordionDetails>
              ...
              {passwordError && oldPassword.length > 1 && (
                <p className="text-red-600 text-xs font-semibold font-nunito">
        ...
        <p className=" my-2 mx-auto text-center font-dancingScript text-purple-600 text-4xl">
          Trell
        </p>
        {/* logout div  */}
        <Button
          className="!my-2 !w-[80%] !mx-auto !flex !justify-center !items-center  !p-2  "
          variant="contained"
          color="secondary"
          onClick={logout}
        >
      ...
      <div className="w-full h-[91vh] flex md:!hidden flex-col items-center overflow-y-auto bg-slate-50 relative scrollbar-thin scrollbar-thumb-purple-300 scrollbar-track-purple-100 transition-all">
        <div
          className={`w-[93%] mx-auto flex justify-center items-center rounded-xl my-7 relative`}
        >
          {!user ? (
            <Skeleton variant="circular" width={100} height={100} />
          ) : (
        ...
        {/* logout div  */}
        <Button
          className="!mt-5 !mb-7 !w-[80%] !mx-auto !flex !justify-center !items-center  !p-2  "
          variant="contained"
          color="secondary"
          onClick={logout}
        >
