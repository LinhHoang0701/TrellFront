...
const ChooseAvatar = () => {
  ...
  return (
    <div className="h-screen w-[90%]  mx-auto flex flex-col md:flex-row items-center ">
      ...
      <div
        className="absolute flex md:hidden top-6 right-4"
      ...
      >
        <Button
          ...
          variant="outlined"
          size="small"
          className="!text-xs !capitalize  !p-2"
          color="secondary"
        >
          Skip for now
        </Button>
      ...
      <div
        className={`${
          selectedAvatar ? "flex" : "hidden"
        }  justify-center items-center text-center w-[50%] mx-auto  mt-20 mb-5 md:my-0 transition-all`}
      >
        <img
      ...
      <div
        className={`${
          !selectedAvatar && !profilePic && !isImageLoading ? "flex" : "hidden"
        }  justify-center items-center text-center w-[50%] mx-auto mt-20 mb-5 md:my-0 transition-all`}
      >
        <img
      ...
      <div
        className={`${
          profilePic || isImageLoading ? "flex" : "hidden"
        }  justify-center items-center text-center w-[50%] mx-auto  mt-20 mb-5 md:my-0 transition-all`}
      >
        {isImageLoading ? (
          ...
          <img
            src={profilePic}
            alt="avatar_logo"
            className=" md:w-56 md:h-56 w-32 h-32 rounded-full object-cover"
          />
        )}
      </div>
      ...
      <div className="flex flex-col justify-center items-center mt-6">
        <p className="flex md:hidden  font-dancingScript text-gray-500 text-[1.6rem] font-semibold tracking-wide">
          Choose avatar
        </p>
        {/* avatars display div  */}
      ...
      <div className="flex flex-col justify-center items-center w-[50%] mx-auto ">
        {uploadMessage && isSuccess && (
          <>
            ...
            >
              <Alert severity="success" className="text-xs md:text-base">
                {uploadMessage}
              </Alert>
            </Snackbar>
          </>
        ...
        {uploadMessage && isError && (
          <>
            <Snackbar
              ...
              anchorOrigin={{ vertical: "top", horizontal: "center" }}
            >
              <Alert severity="error" className="text-xs md:text-base">
                {uploadMessage}
              </Alert>
            </Snackbar>
          </>
        )}
        <p className="hidden md:flex text-center font-dancingScript text-gray-500 text-4xl font-semibold">
          Choose avatar
        </p>
        <div className="hidden md:flex justify-evenly mx-auto space-x-4 space-y-2 items-center w-[100%] flex-wrap my-2">
          ...
          {avatars?.map((avatar, index) => {
            return loading ? (
              ...
              <div
                className={`w-28 h-28 rounded-full  flex justify-center items-center cursor-pointer  ${
                  selectedAvatar === avatars[index]
                    ? "border-4 border-green-500"
                    : ""
                } transition-all`}
        ...
        <h1 className="hidden md:flex  my-2 font-nunito text-xl text-gray-800">
          or
        </h1>
        ...
        <div className=" hidden w-[80%] mx-auto md:flex md:flex-col border-dashed border-2 h-36 border-purple-300 rounded-lg my-3 justify-center items-center ">
          ...
          <label htmlFor="contained-button-file">
            ...
            <Button
              variant="contained"
              component="span"
              className="!font-nunito !tracking-wide !my-2 !capitalize  !opacity-80"
              color="success"
              size="small"
            >
              Upload Profile Pic
        ...
        <div className="hidden md:flex items-center justify-center w-[80%] mx-auto space-x-4 my-4 ">
          <Button
            ...
            size="small"
            color="secondary"
            className="!text-sm !capitalize !font-nunito !p-2 !my-2 !flex-1"
          >
            Skip for now
          </Button>
          <Button
            aria-label="skip"
            onClick={handleAvatarUploadAndContinue}
            variant="contained"
            size="small"
            color="secondary"
            className={`!text-sm !capitalize !opacity-90 !font-nunito !p-2 !my-2 !flex-1 ${
              isLoading
                ? "!bg-gradient-to-tr from-gray-300 via-gray-300 to-gray-300 !opacity-40 "
                : ""
      ...
      <h1 className="flex md:hidden my-2 font-nunito text-sm text-gray-800">
        or
      </h1>
      <div className=" flex w-[90%] mx-auto md:hidden flex-col border-dashed border-2 h-36 border-purple-300 rounded-lg my-3 justify-center items-center  !lowercase">
        ...
        <label htmlFor="contained-button-file">
          ...
          <Button
            variant="contained"
            component="span"
            className="!font-nunito !tracking-wide !my-2 !capitalize  !opacity-70"
            color="success"
            size="small"
          >
            Upload Profile Pic
      ...
      <div className="flex md:hidden  w-[100%] mx-auto items-center justify-center my-8">
        <Button
          ...
          size="medium"
          color="secondary"
          className={` !text-sm !capitalize !w-[90%] !mx-auto !font-nunito !p-2 !opacity-70 ${
            isLoading
              ? "!bg-gradient-to-tr from-gray-300 via-gray-300 to-gray-300 !opacity-40 "
              : ""
          } !bg-gradient-to-tr from-rose-400 via-fuchsia-500 to-indigo-500`}
