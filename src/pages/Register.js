  ...
  return (
    <div className="h-screen md:w-screen w-[80%] mx-auto flex flex-col md:flex-row items-center justify-center ">
      ...
      <div className="w-[50%] flex justify-center items-center">
        <img
          src="/assets/hellocat.svg"
          alt="left hero banner"
          className="md:h-96 h-56 mt-2 md:mt-0 "
        />
      </div>
      ...
      <div className="hidden md:flex md:absolute md:top-[50%] md:left-[50%] md:-translate-x-[50%] md:-translate-y-[50%] w-auto z-40  ">
        <img
          ...
          alt="logo"
          className="md:h-14 md:w-24 h-0 w-0 "
        />
      </div>

      {/* register form  */}
      <div className="w-[50%] flex justify-center items-center flex-col">
        <h2 className="font-dancingScript font-bold text-gray-600 tracking-wide text-2xl md:text-4xl mb-2 mt-6 md:mt-0 w-80">
          Hello..!
        </h2>
        <form
          className="my-2 flex flex-col items-center justify-start"
        ...
        >
          ...
          <TextField
            ...
            InputProps={{
              startAdornment: (
                <InputAdornment position="start">
                  {" "}
                  <AlternateEmailIcon fontSize="1rem" />
                </InputAdornment>
              ),
            }}
          ...
          <p className="text-xs md:text-sm text-gray-500 font-nunito font-light mt-4">
            By signing up, you agree to our{" "}
            <span className="text-purple-700 font-medium">
              Terms & Conditions
            </span>{" "}
            and{" "}
            <span className="text-purple-700 font-medium">Private Policy</span>
          </p>

          <Button
            type="submit"
            className={`!w-80 !p-2 !text-sm !md:text-base !font-nunito !mt-10 !mb-4 !tracking-wide !opacity-[.70] !md:opacity-[.80] !rounded-lg !text-white !transition-all !capitalize ${
              isLoading
        ...
        <p className="text-xs md:text-sm text-gray-500 font-nunito font-light tracking-wide -mt-2 mb-3">
          Joined us before?{" "}
          <span
